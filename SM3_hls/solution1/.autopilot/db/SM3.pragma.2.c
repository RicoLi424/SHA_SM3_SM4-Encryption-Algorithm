...
void processmessageblock(uint32_t intermediateHash[8], uint32_t messageBlock[16])
{_ssdm_SpecArrayDimSize(intermediateHash, 8);_ssdm_SpecArrayDimSize(messageBlock, 16);
 uint7_t i;
 uint32_t W[68];
 uint32_t W_[64];
...
void SM3Calc(uint8_t message[32], uint8_t messageLen, uint32_t digest[8])
{_ssdm_SpecArrayDimSize(message, 32);_ssdm_SpecArrayDimSize(digest, 8);
 uint512_t pack;
 uint32_t messageBlock[16];
 uint32_t intermediateHash[8];
 uint6_t i;
 ...
 for (i = 0; i < 32; i++)
 {
  pack = ({ ; typeof(pack) __Result__ = 0; typeof(pack) __Val2__ = pack; typeof(message[i]) __Repl2__ = message[i]; __builtin_bit_part_set((void*)(&__Result__), (void*)(&__Val2__), (void*)(&__Repl2__), i * 8, i * 8 + 7); __Result__; });

 }

 pack = pack << ( 512 - messageLen );

 pack = ({ ; typeof(pack) __Result__ = 0; typeof(pack) __Val2__ = pack; typeof(1) __Repl2__ = !!1; __builtin_bit_part_set((void*)(&__Result__), (void*)(&__Val2__), (void*)(&__Repl2__), 511 - messageLen, 511 - messageLen); __Result__; });

 pack = ({ ; typeof(pack) __Result__ = 0; typeof(pack) __Val2__ = pack; typeof(messageLen) __Repl2__ = messageLen; __builtin_bit_part_set((void*)(&__Result__), (void*)(&__Val2__), (void*)(&__Repl2__), 0, 7); __Result__; });

 for (i = 0; i < 16; i++)
 {
  messageBlock[i] = ({ ; unsigned int __attribute__((bitwidth(__bitwidthof__(pack)))) __Result__ = 0; unsigned int __attribute__((bitwidth(__bitwidthof__(pack)))) __Val2__ = pack; __builtin_bit_part_select((void*)(&__Result__), (void*)(&__Val2__), i * 32, i * 32 + 31); __Result__; });
 }
