...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "SM3Calc.autotvin.dat"
	set constFileTvOut       "SM3Calc.autotvout.dat"
	set constFileHdlTvIn     "SM3Calc.autohdltvin.dat"
	set constFileHdlTvOut    "SM3Calc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
