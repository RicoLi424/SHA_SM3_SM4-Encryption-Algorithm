...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.SM3Calc.autotvin_message.dat"
         "c.SM3Calc.autotvin_messageLen.dat"
         "c.SM3Calc.autotvin_digest.dat"
         "c.SM3Calc.autotvout_digest.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.SM3Calc.autotvout_digest.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
