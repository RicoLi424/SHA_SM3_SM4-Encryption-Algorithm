...
// ==============================================================
# 1 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c"
# 1 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c" 2
...
# 2 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c" 2
# 1 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.h" 1
...
# 4 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.h" 2

typedef uint512 uint512_t;
typedef uint32 uint32_t;
typedef uint8 uint8_t;
typedef uint7 uint7_t;
typedef uint6 uint6_t;
typedef uint5 uint5_t;
...
# 3 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c" 2
...
# 26 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c"
...
# 121 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c"
 for (i = 0; i < 16; i++)
 {
  W[15 - i] = messageBlock[i];

 }
# 134 "D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c"
 for (i = 16; i < 68; i++)
 {
...
void SM3Calc(uint8_t message[32], uint8_t messageLen, uint32_t digest[8])
{
 ...
 for (i = 0; i < 32; i++)
 {
  pack = ({ (void) ((!!((i * 8 + 7 >= 0 && i * 8 + 7 < (__bitwidthof__(typeof(pack))) && i * 8 < (__bitwidthof__(typeof(pack))) && i * 8 >= 0) && "Part select out of range")) || (_assert("(i * 8 + 7 >= 0 && i * 8 + 7 < (__bitwidthof__(typeof(pack))) && i * 8 < (__bitwidthof__(typeof(pack))) && i * 8 >= 0) && \"Part select out of range\"","D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c",212),0)); typeof(pack) __Result__ = 0; typeof(pack) __Val2__ = pack; typeof(message[i]) __Repl2__ = message[i]; __builtin_bit_part_set((void*)(&__Result__), (void*)(&__Val2__), (void*)(&__Repl2__), i * 8, i * 8 + 7); __Result__; });

 }

 pack = pack << ( 512 - messageLen );

 pack = ({ (void) ((!!((511 - messageLen >= 0 && 511 - messageLen < ((__bitwidthof__(typeof(pack))))) && "Bit select out of range")) || (_assert("(511 - messageLen >= 0 && 511 - messageLen < ((__bitwidthof__(typeof(pack))))) && \"Bit select out of range\"","D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c",218),0)); typeof(pack) __Result__ = 0; typeof(pack) __Val2__ = pack; typeof(1) __Repl2__ = !!1; __builtin_bit_part_set((void*)(&__Result__), (void*)(&__Val2__), (void*)(&__Repl2__), 511 - messageLen, 511 - messageLen); __Result__; });

 pack = ({ (void) ((!!((7 >= 0 && 7 < (__bitwidthof__(typeof(pack))) && 0 < (__bitwidthof__(typeof(pack))) && 0 >= 0) && "Part select out of range")) || (_assert("(7 >= 0 && 7 < (__bitwidthof__(typeof(pack))) && 0 < (__bitwidthof__(typeof(pack))) && 0 >= 0) && \"Part select out of range\"","D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c",220),0)); typeof(pack) __Result__ = 0; typeof(pack) __Val2__ = pack; typeof(messageLen) __Repl2__ = messageLen; __builtin_bit_part_set((void*)(&__Result__), (void*)(&__Val2__), (void*)(&__Repl2__), 0, 7); __Result__; });

 for (i = 0; i < 16; i++)
 {
  messageBlock[i] = ({ (void) ((!!((i * 32 + 31 >= 0 && i * 32 + 31 < (__bitwidthof__(typeof(pack))) && i * 32 < (__bitwidthof__(typeof(pack))) && i * 32 >= 0) && "Part select out of range")) || (_assert("(i * 32 + 31 >= 0 && i * 32 + 31 < (__bitwidthof__(typeof(pack))) && i * 32 < (__bitwidthof__(typeof(pack))) && i * 32 >= 0) && \"Part select out of range\"","D:/vivado/sm3/hls_prj/SM3/SM3/src/SM3.c",224),0)); unsigned int __attribute__((bitwidth(__bitwidthof__(pack)))) __Result__ = 0; unsigned int __attribute__((bitwidth(__bitwidthof__(pack)))) __Val2__ = pack; __builtin_bit_part_select((void*)(&__Result__), (void*)(&__Val2__), i * 32, i * 32 + 31); __Result__; });
 }
