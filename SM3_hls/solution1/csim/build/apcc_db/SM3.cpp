...
extern "C" signed int intermediateHash[8];
extern "C" signed int messageBlock[16];

/* Function Declarations */
double fmod(double, double);
float fmodf(float, float);
long double fmodl(long double, long double);
extern "C" signed int LeftRotate(signed int llvm_cbe_X,  char llvm_cbe_i);
extern "C" signed int T( char llvm_cbe_i);
extern "C" signed int FF(signed int llvm_cbe_X, signed int llvm_cbe_Y, signed int llvm_cbe_Z,  char llvm_cbe_i);
extern "C" signed int GG(signed int llvm_cbe_X, signed int llvm_cbe_Y, signed int llvm_cbe_Z,  char llvm_cbe_i);
extern "C" signed int P0(signed int llvm_cbe_X);
extern "C" signed int P1(signed int llvm_cbe_X);
extern "C" void initial(signed int *llvm_cbe_X);
extern "C" void processmessageblock(signed int *llvm_cbe_intermediateHash, signed int *llvm_cbe_messageBlock);
extern "C" void SM3Calc( char *llvm_cbe_message,  char llvm_cbe_messageLen, signed int *llvm_cbe_digest);


/* Global Variable Definitions and Initialization */
static  char aesl_internal__OC_str2[19] = "../../../src/SM3.c";
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = xor i32 %%12, 511, !dbg !10 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_603_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = zext i6 %%storemerge16 to i32, !dbg !12 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_656_count);
  llvm_cbe_tmp__181 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_storemerge16&63U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__181);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = shl nuw nsw i32 %%20, 5, !dbg !12 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_657_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__185);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = add i6 %%storemerge16, 1, !dbg !13 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_675_count);
...
llvm_cbe_tmp__224:
if (AESL_DEBUG_TRACE)
printf("\n  call void @_assert(i8* getelementptr inbounds ([155 x i8]* @aesl_internal_.str5, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8]* @aesl_internal_.str2, i64 0, i64 0), i32 224) nounwind, !dbg !12 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_660_count);
...
llvm_cbe_tmp__225:
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = getelementptr inbounds [8 x i32]* %%intermediateHash, i64 0, i64 0, !dbg !15 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_737_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @initial(i32* %%39), !dbg !15 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_738_count);
  initial((signed int *)llvm_cbe_tmp__196);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = getelementptr inbounds [16 x i32]* %%messageBlock, i64 0, i64 0, !dbg !15 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_739_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @processmessageblock(i32* %%39, i32* %%40), !dbg !15 for 0x%I64xth hint within @SM3Calc  --> \n", ++aesl_llvm_cbe_740_count);
