...
void SM3Calc( char *,  char , signed int *);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @SM3Calc(i8* %%3, i8 zeroext 24, i32* %%20) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_70_count);
  SM3Calc(( char *)llvm_cbe_tmp__3, ((unsigned char )24), (signed int *)llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE) {
